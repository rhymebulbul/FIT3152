...
# Calculate correlation matrix for Croatia with pairwise deletion
cro_cor <- cor(numeric_croatia, use = "pairwise.complete.obs")

# Reshape matrix to long format for plotting
cro_melted <- reshape2::melt(cro_cor)

# Create correlation plot for Croatia
cro_cor_plot <- ggplot(data = cro_melted) +
