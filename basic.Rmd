...
An initial look is taken at the correlation between predictor and pro-social attitude for Croatia. The `cor()` function is used and the correlation matrix is visualised with a heatmap.
