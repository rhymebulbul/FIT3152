...
global_cor <- cor(numeric_others, use = "complete.obs")

global_melted <- reshape2::melt(global_cor)

global_cor_plot <- ggplot(data = global_melted) +
